...
public class PIDflipbar extends LinearOpMode {

    //hardwarePIDFlibar.java
    DistanceSensor sensorRange;
    Servo balServo;


    public static double currentValue = 0.0; //currentValue obtained from Distance Sensor
    public static double setValue = 1; //Desired position from sensor (cm)
